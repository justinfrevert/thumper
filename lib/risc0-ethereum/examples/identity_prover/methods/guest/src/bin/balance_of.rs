...
fn main() {
    ...
    let private_key: String = env::read();
    ...
    // TODO: We need to prove that we own this private key. There are a number of ways we could do this. We could check the ecdsa signature verification example or calculate the public key manually
    ...
    // TODO: check we are a member in this collection
    // assert!(member_digest.is_some());
    // env::commit(&digest.as_slice());
    // Test known commitment can be used for later comoposition
